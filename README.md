...
- Key steps:
  - Sampling for efficient modelling
...
| Random Forest | 0.999 | **0.889** | Best performance but overfits |

➡️ **Random Forest selected as best model**
...
- Financial stability indicators strongly influence risk
- Useful for improved credit scoring and loan approval decisions
